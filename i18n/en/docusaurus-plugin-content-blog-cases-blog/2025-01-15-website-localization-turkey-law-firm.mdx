...
<img width="480" src={require('@site/static/images/cases/website-localization-turkey-law-firm/cover.png').default} className="rounded-xl shadow-md mb-8" alt="LegitLaw Case" />

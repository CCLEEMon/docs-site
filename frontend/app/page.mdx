...
import { PluginIcon, AIIcon, ZapIcon, TrendIcon, ShieldIcon, LightbulbIcon, ArrowRightIcon, MessageCircleIcon } from './components/Icons'
import { HeroBackground, HeroCounter } from './components/HeroSection'
...
<div className="relative min-h-[85vh] flex flex-col items-center justify-center px-5 pt-[100px] pb-[80px] -mt-10 -mx-[calc(50vw-50%)] text-center overflow-hidden">
  {/* 深色渐变背景 - slate到purple到indigo */}
  <div className="absolute inset-0 pointer-events-none bg-gradient-to-br from-slate-900 via-purple-900 to-indigo-900" />
  ...
  <div className="absolute inset-0 pointer-events-none overflow-hidden">
    <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[radial-gradient(circle,rgba(168,85,247,0.4)_0%,rgba(147,51,234,0.1)_50%,transparent_70%)] rounded-full blur-[120px] animate-pulse" />
    <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[radial-gradient(circle,rgba(99,102,241,0.4)_0%,rgba(79,70,229,0.1)_50%,transparent_70%)] rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '1.5s' }} />
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(236,72,153,0.2)_0%,transparent_60%)] rounded-full blur-[150px] animate-pulse" style={{ animationDelay: '0.5s' }} />
  </div>
  ...
  <div className="relative z-10 animate-fadeInUp">
    <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black leading-tight mb-6 bg-gradient-to-r from-indigo-400 via-purple-400 to-blue-400 bg-clip-text tracking-tight max-w-[900px]">
      AI 驱动的电商运营工具
    </h1>

    <div className="text-lg sm:text-xl lg:text-2xl text-indigo-100 mb-12 leading-relaxed max-w-[700px]">
...
<div className="max-w-[1200px] mx-auto px-5 py-20">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-32">
    <a
      href="/browser-plugin"
      className="animate-scaleIn group p-6 rounded-2xl bg-white/80 backdrop-blur-md border border-white/20 text-inherit block shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] ring-1 ring-white/10 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.6)] hover:shadow-indigo-500/20 hover:-translate-y-2 hover:border-indigo-400 transition-all duration-300"
    ...
    <div className="animate-scaleIn group p-6 rounded-2xl bg-white/80 backdrop-blur-md border border-white/20 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] ring-1 ring-white/10 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.6)] hover:shadow-indigo-500/20 hover:-translate-y-2 hover:border-indigo-400 transition-all duration-300" style={{ animationDelay: '0.3s' }}>
      <div className="rounded-xl overflow-hidden mb-6 border border-white/30 bg-gradient-to-br from-white/60 to-white/40 aspect-[4/3] shadow-inner">
        <img

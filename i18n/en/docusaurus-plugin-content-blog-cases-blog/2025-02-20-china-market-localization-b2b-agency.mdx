...
<img width="480" src={require('@site/static/images/cases/china-market-localization-b2b-agency/mobile.png').default} className="rounded-xl shadow-md mb-8" alt="China Market Localization Case" />
